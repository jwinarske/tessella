 ...
 *
 * The tessella capture-stream ABI, revision 3.
 *
...
/* The surface a view draws its tiles on. A toggle rather than a mode a map is created in. Under */
/* MERCATOR proj_matrix is the whole projection; under GLOBE the bend is tile-local -> normalized */
/* Mercator -> sphere -> clip and globe_matrix is its last step. */
typedef enum tsl_projection_mode {
    TSL_PROJECTION_MODE_MERCATOR = 0,
    TSL_PROJECTION_MODE_GLOBE = 1,
} tsl_projection_mode;
...
typedef struct tsl_camera_update {
    ...
    /*  */
    /* The last step of a globe's bend and the only linear one: geometry goes tile-local -> */
    /* normalized Mercator -> sphere -> clip, and the middle step is trig the consumer's vertex */
    /* stage supplies. */
    ...
    /* where a round one was asked for. */
    uint8_t projection;
    /* Must be zero. */
    uint8_t _pad[3];
} tsl_camera_update;

TSL_ASSERT(sizeof(tsl_camera_update) == 400, "tsl_camera_update size differs from the Rust definition");
...
TSL_ASSERT(offsetof(tsl_camera_update, globe_matrix) == 128, "tsl_camera_update.globe_matrix moved");
TSL_ASSERT(offsetof(tsl_camera_update, center_zoom0) == 256, "tsl_camera_update.center_zoom0 moved");
TSL_ASSERT(offsetof(tsl_camera_update, bearing) == 272, "tsl_camera_update.bearing moved");
TSL_ASSERT(offsetof(tsl_camera_update, pitch) == 280, "tsl_camera_update.pitch moved");
TSL_ASSERT(offsetof(tsl_camera_update, pixels_per_meter) == 288, "tsl_camera_update.pixels_per_meter moved");
TSL_ASSERT(offsetof(tsl_camera_update, light) == 296, "tsl_camera_update.light moved");
TSL_ASSERT(offsetof(tsl_camera_update, frame_no) == 368, "tsl_camera_update.frame_no moved");
TSL_ASSERT(offsetof(tsl_camera_update, order_epoch) == 376, "tsl_camera_update.order_epoch moved");
TSL_ASSERT(offsetof(tsl_camera_update, view) == 384, "tsl_camera_update.view moved");
TSL_ASSERT(offsetof(tsl_camera_update, opaque_pass_cutoff) == 388, "tsl_camera_update.opaque_pass_cutoff moved");
TSL_ASSERT(offsetof(tsl_camera_update, depth_range_size) == 392, "tsl_camera_update.depth_range_size moved");
TSL_ASSERT(offsetof(tsl_camera_update, projection) == 396, "tsl_camera_update.projection moved");
TSL_ASSERT(offsetof(tsl_camera_update, _pad) == 397, "tsl_camera_update._pad moved");
